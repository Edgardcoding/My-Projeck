...
const ChatMasyarakat = ({ navigation, route }) => {
  const { jsonData } = route.params;

  useEffect(() => {
    console.log("SKARANG DI LIST MASYARAKAT SCREEN ");
  ...
  return (
    <ScrollView style={styles.container}>
      <View>
        <Text style={styles.god}>Chat Pengepul</Text>
      </View>
        ...
        return (
          <View style={styles.card} key={data.id}>
            ...
            <TouchableOpacity
              ...
              onPress={() => handleChatButtonPress(data.nama, data.nomor, data.pesan)}
            >
