...
<View style={styles.userProfile}>
    ...
    />
        ...
        <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('Lapor', {jsonData})}>
          <Image source={require('../Home/Image/laporan.png')} style={styles.menuItemImage} />
          <Text style={styles.menuItemText}>𝙱𝚞𝚊𝚝 𝙻𝚊𝚙𝚘𝚛𝚊𝚗</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('Maps1')}>
          <Image source={require('../Home/Image/maps.png')} style={styles.menuItemImage} />
          <Text style={styles.menuItemText}>𝙻𝚘𝚔𝚊𝚜𝚒</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('information_M')}>
          <Image source={require('../Home/Image/informasi.png')} style={styles.menuItemImage} />
          <Text style={styles.menuItemText}>𝙸𝚗𝚏𝚘𝚛𝚖𝚊𝚜𝚒</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('Chat1', {jsonData})}>
